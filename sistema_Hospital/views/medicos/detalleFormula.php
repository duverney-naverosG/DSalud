  ...
  <body>
    ...
    <div class="layout-wrapper layout-content-navbar">
      <div class="layout-container">
        <!-- Menu -->
        <?php include "../../components/menuMedicos.php" ; ?>
        <!-- / Menu -->
                ...
                <div class="col-xxl">
                  <div class="card mb-4">
                    <div class="card-header d-flex align-items-center justify-content-between">
                      <h5 class="mb-0">DETALLE FORMULA</h5>
                    </div>
                    <div class="card-body">
                      <form>
                        <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                          <label class="col-sm-2 col-form-label" for="basic-default-company">ID historial</label>
                          <div class="col-sm-10">
