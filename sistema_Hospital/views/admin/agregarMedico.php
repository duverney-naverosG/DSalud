                                ...
                                <div class="content-wrapper">
                                    ...
                                    <div class="container-xxl flex-grow-1 container-p-y">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="card mb-4">
                                                    <h5 class="card-header">AGREGAR MEDICO</h5>
                                                    <!-- Account -->
                                                    <hr class="my-0" />
                                                    <div class="card-body">
                                                        <form id="formAccountSettings" method="POST"  action="../../../sistema_Hospital/controllers/medico.php">
                                                            <div class="row">
                                                                ...
                                                                ?>
                                                                        <option value="<?php echo $hospital->getId(); ?>"> <?php echo $hospital->getNombre();?></option>
                                                                        <?php }?>
                                                                    </select>
                                                                </div>
                                                                <div class="mb-3 col-md-6">
