          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <div class="row">
                <div class="col-md-12">
                  <div class="card mb-4">
                    <h5 class="card-header">DETALLE PACIENTE</h5>
                    <!-- Account -->
                    <hr class="my-0" />
                    <div class="card-body">
                      <form id="formAccountSettings" method="POST" action="#">
                        ...
                        <div class="mt-2">
                          <a href="/sistema_Hospital/views/admin/pacientes.php"  class="btn btn-outline-success" type="reset" role="button">VOLVER</a>
                      </form>
                    </div>
                    <!-- /Account -->
                  </div>
